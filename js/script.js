window.onload = function(){
	...
	function keyupHandler(e){
		...
		zezim.posX = Math.max(0, Math.min(cnv.width - zezim.width, zezim.posX));
		zezim.posY = Math.max(0, Math.min(cnv.height - zezim.height, zezim.posY));
